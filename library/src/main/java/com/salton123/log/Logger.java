...
import com.salton123.log.internal.DefaultsFactory;
import com.salton123.log.internal.SystemCompat;
import com.salton123.log.internal.util.StackTraceUtil;
import com.salton123.log.printer.Printer;
import com.salton123.log.printer.PrinterSet;
import com.salton123.log.formatter.border.BorderFormatter;
import com.salton123.log.formatter.message.json.JsonFormatter;
import com.salton123.log.formatter.message.object.ObjectFormatter;
import com.salton123.log.formatter.message.throwable.ThrowableFormatter;
...
public class Logger {
  ...
  public static class Builder {
     ...
     * it can be a package name like "com.salton123.log", a class name like "com.yourdomain.logWrapper",
     ...
     *                         "com.salton123.log", a class name like "com.yourdomain.logWrapper",
     *                         or something else between package name and class name, like "com.yourdomain.".
     *                         It is mostly used when you are using a logger wrapper
     * @param depth            the number of stack trace elements we should log, 0 if no limitation
     * @return the builder
